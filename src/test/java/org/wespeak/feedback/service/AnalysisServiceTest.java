...
class AnalysisServiceTest {
    ...
    @Mock
    private UserFeedbackStatsRepository statsRepository;
    ...
    @BeforeEach
    void setUp() {
        testTranscript = Transcript.builder()
                .id("trans-123")
    ...
    void shouldCreateFeedbackForTranscript() {
        ...
        when(feedbackRepository.findTop5ByUserIdAndTargetLanguageCodeOrderByCreatedAtDesc(anyString(), anyString()))
                .thenReturn(List.of());
