...
public interface FeedbackRepository extends MongoRepository<Feedback, String> {
    ...
    Page<Feedback> findByUserIdAndTargetLanguageCode(String userId, String languageCode, Pageable pageable);
    Optional<Feedback> findBySessionIdAndUserId(String sessionId, String userId);
    List<Feedback> findTop5ByUserIdAndTargetLanguageCodeOrderByCreatedAtDesc(String userId, String languageCode);
}
